                    ...
                    <div className={classes.timeline_centered}>
                      <Fade bottom>
                        <article className={classes.timeline_entry}>
                          ...
                          <div className={classes.label}>
                            <h2>
                              Experience <span>December 2016 - Present</span>
                            </h2>
                            <p>
                              ...
                              where I develop and mantain web apps with the
                              following technologies:
                            </p>
                            <li>
                              Framework and solutions: Ruby on Rails (RoR),
                              Node.js, Express, Spree e-commerce, ActiveAdmin,
                              Redis, Elasticsearch
                            </li>
                            <li>
                      ...
                      <Fade bottom>
                        <article className={classes.timeline_entry}>
                          ...
                          <div className={classes.label}>
                            <h2>
                              Experience <span>June 2016 - November 2016</span>
                            </h2>
                            <p>
                              ...
                              where I first approached coding challenges and
                              where I:
                            </p>
                            <li>Developed management software</li>
                            <li>
                              Developed single-page applications for iOS and
                              Android smartphones and tablets.
                            </li>
                            <li>
                              Developed landing pages with responsive design
                            </li>
                          </div>
                        </article>
                      </Fade>
                      <Fade bottom>
                        <article className={classes.timeline_entry}>
                          ...
                          <div className={classes.label}>
                            ...
                            <p>
                              I completed my bachelor degree in Astronomy
                            ...
                            <p>
                              The core topics were Statistics, Mathematics,
                              Physics, Astrophysics, Astronomy and Quantum
                              Physics
                            </p>
                          </div>
                        </article>
                      ...
                      <Fade bottom>
                        <article className={classes.timeline_entry}>
                          ...
                          <div className={classes.label}>
                            ...
                            <p>
                              I completed my higher education in Informatics
                              from{" "}
                              <a
                                rel="noopener noreferrer"
                                target="_blank"
                              ...
                              with major subjects as Programming languages
                              (Java, PHP), SQL and computer network bases.
                            </p>
                          </div>
