                      ...
                      <Fade bottom>
                        <article className={classes.timeline_entry}>
                          ...
                          <div className={classes.label}>
                            ...
                            <p>I completed my bachelor degree in Astronomy (Computer Science and Engineering) from <a target='_blank' href='https://www.unipd.it/en/'><b>University of Padua</b></a>.</p>
                      ...
                      <Fade bottom>
                        <article className={classes.timeline_entry}>
                          ...
                          <div className={classes.label}>
                            ...
                            <p>I have completed my higher education in Informatics from <a target='_blank' href="https://www.marconiverona.edu.it/"><b>ITIS G.Marconi</b></a> with major subjects as Programming languages (Java, PHP), SQL and computer network bases.</p>
                          </div>
